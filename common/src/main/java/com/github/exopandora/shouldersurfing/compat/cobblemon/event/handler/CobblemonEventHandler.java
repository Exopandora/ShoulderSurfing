...
//				event.setCameraRotation(new Vec2f(vehicleController.getPitch(), vehicleController.getYaw()));
//			}
//		}
	}
...
//	private static boolean hasActiveBehaviour(@Nullable Entity entity, Identifier behavior) {
