...
public class BuiltinPlugin implements IShoulderSurfingPlugin {
	...
	public void register(IEventBus eventBus) {
		...
		eventBus.register(-10000, ComputeTargetCameraOffsetEventHandlerImpl.CameraDistanceAttribute.INSTANCE);
		eventBus.register(-9000, ComputeTargetCameraOffsetEventHandlerImpl.CameraDistanceAttributePassenger.INSTANCE);
