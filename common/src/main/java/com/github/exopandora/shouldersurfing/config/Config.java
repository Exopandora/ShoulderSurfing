...
import com.github.exopandora.shouldersurfing.mixin.ResourceLocationAccessor;
...
public class Config {
	...
	public static class ClientConfig implements IClientConfig {
		...
		protected static boolean isValidItemPropertyWithSlot(Object id) {
			...
			return ResourceLocationAccessor.invokeIsValidNamespace(split[0]) && ResourceLocation.tryParse(split[1]) != null;
		}
	}
