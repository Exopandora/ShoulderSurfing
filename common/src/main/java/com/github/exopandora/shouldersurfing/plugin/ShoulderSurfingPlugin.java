...
import com.github.exopandora.shouldersurfing.compat.cobblemon.plugin.callback.CobblemonAdaptiveItemCallback;
import com.github.exopandora.shouldersurfing.compat.cobblemon.plugin.callback.CobblemonCameraRotationSetupCallback;
import com.github.exopandora.shouldersurfing.compat.cobblemon.plugin.callback.CobblemonPlayerInputCallback;
import com.github.exopandora.shouldersurfing.compat.cobblemon.plugin.callback.CobblemonPlayerStateCallback;
import com.github.exopandora.shouldersurfing.compat.create.plugin.callback.CreateModTargetCameraOffsetCallback;
import com.github.exopandora.shouldersurfing.compat.curios.plugin.callback.ICuriosAdaptiveItemCallback;
import com.github.exopandora.shouldersurfing.plugin.callback.AdaptiveItemCallback;
import com.github.exopandora.shouldersurfing.plugin.callback.CameraCouplingCallback;
import com.github.exopandora.shouldersurfing.plugin.callback.CameraEntityTransparencyCallback;
import com.github.exopandora.shouldersurfing.plugin.callback.CameraEntityTransparencyCallbackWhenAiming;
import com.github.exopandora.shouldersurfing.plugin.callback.PlayerStateCallback;
import com.github.exopandora.shouldersurfing.plugin.callback.TargetCameraOffsetCallback;
