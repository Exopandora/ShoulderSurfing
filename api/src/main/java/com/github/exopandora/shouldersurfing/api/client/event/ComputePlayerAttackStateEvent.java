...
/**
 * This event can be used to implement custom attack state behavior.
 *
 * @since 5.0.0
 */
public class ComputePlayerAttackStateEvent extends CancellableEvent {
	private final LivingEntity cameraEntity;
	private boolean result;
	
	public ComputePlayerAttackStateEvent(LivingEntity cameraEntity) {
