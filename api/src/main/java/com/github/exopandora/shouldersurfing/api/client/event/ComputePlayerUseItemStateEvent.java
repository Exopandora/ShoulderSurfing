...
/**
 * This event can be used to implement custom item use state behavior.
 *
 * @since 5.0.0
 */
public class ComputePlayerUseItemStateEvent extends CancellableEvent {
	private final LivingEntity cameraEntity;
	private boolean result;
	
	public ComputePlayerUseItemStateEvent(LivingEntity cameraEntity) {
