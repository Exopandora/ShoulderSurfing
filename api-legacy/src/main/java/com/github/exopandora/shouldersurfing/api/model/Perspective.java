...
public enum Perspective {
	...
	public com.github.exopandora.shouldersurfing.api.client.Perspective toNewApi() {
		return switch (this) {
			case FIRST_PERSON -> com.github.exopandora.shouldersurfing.api.client.Perspective.FIRST_PERSON;
			case THIRD_PERSON_BACK -> com.github.exopandora.shouldersurfing.api.client.Perspective.THIRD_PERSON_BACK;
			case THIRD_PERSON_FRONT -> com.github.exopandora.shouldersurfing.api.client.Perspective.THIRD_PERSON_FRONT;
			case SHOULDER_SURFING -> com.github.exopandora.shouldersurfing.api.client.Perspective.SHOULDER_SURFING;
		};
	}
	
	public static Perspective fromNewApi(com.github.exopandora.shouldersurfing.api.client.Perspective perspective) {
		return switch (perspective) {
			case FIRST_PERSON -> FIRST_PERSON;
			case THIRD_PERSON_BACK -> THIRD_PERSON_BACK;
			case THIRD_PERSON_FRONT -> THIRD_PERSON_FRONT;
			case SHOULDER_SURFING -> SHOULDER_SURFING;
		};
	}
}
