...
class ObjectPickerAdapter implements IObjectPicker {
	...
	@Override
	public HitResult pick(com.github.exopandora.shouldersurfing.api.client.world.phys.PickContext context, double interactionRange, float partialTick, Player player) {
		return this.objectPicker.pick(context, interactionRange, partialTick, player);
	}
