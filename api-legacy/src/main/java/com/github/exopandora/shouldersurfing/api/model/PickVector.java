...
public enum PickVector {
	...
	public com.github.exopandora.shouldersurfing.api.client.world.phys.PickVector toNewApi() {
		return switch (this) {
			case PLAYER -> com.github.exopandora.shouldersurfing.api.client.world.phys.PickVector.PLAYER;
			case CAMERA -> com.github.exopandora.shouldersurfing.api.client.world.phys.PickVector.CAMERA;
		};
	}
	
	public static PickVector fromNewApi(com.github.exopandora.shouldersurfing.api.client.world.phys.PickVector pickVector) {
		return switch (pickVector) {
			case PLAYER -> PLAYER;
			case CAMERA -> CAMERA;
		};
	}
