...
class ClientConfigAdapter implements IClientConfig {
	...
	public CameraDistanceAttributeMode getCameraDistanceAttributeMode() {
		return CameraDistanceAttributeMode.fromNewApi(this.config.getCameraConfig().getCameraDistanceAttributeMode());
	}
	...
	public List<? extends String> getAdaptiveCrosshairHoldItemAnimations() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairHoldItemAnimations();
	}
	
	@Override
	public List<? extends String> getAdaptiveCrosshairUseItemAnimations() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairUseItemAnimations();
	}
	
	@Override
	public List<? extends String> getAdaptiveCrosshairHoldItemDefaultComponents() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairHoldItemDefaultComponents();
	}
	
	@Override
	public List<? extends String> getAdaptiveCrosshairUseItemDefaultComponents() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairUseItemDefaultComponents();
	}
	
	@Override
	public List<? extends String> getAdaptiveCrosshairHoldItemComponents() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairHoldItemComponents();
	}
	
	@Override
	public List<? extends String> getAdaptiveCrosshairUseItemComponents() {
		return this.config.getCrosshairConfig().getAdaptiveCrosshairUseItemComponents();
	}
	...
	public List<? extends String> getCuriosAdaptiveCrosshairDefaultItemComponents() {
		return this.config.getIntegrationsConfig().getCuriosAdaptiveCrosshairDefaultItemComponents();
	}
	
	@Override
	public List<? extends String> getCuriosAdaptiveCrosshairItemComponents() {
		return this.config.getIntegrationsConfig().getCuriosAdaptiveCrosshairItemComponents();
	}
