...
public sealed abstract class PickContext permits OffsetPickContext, DynamicPickContext, ObstructionPickContext {
	...
	public com.github.exopandora.shouldersurfing.api.client.world.phys.PickContext toNewApi() {
		return switch (this) {
			case OffsetPickContext offsetPickContext ->
				new com.github.exopandora.shouldersurfing.api.client.world.phys.OffsetPickContext(
					this.camera,
					fluidContext,
					entity,
					entityFilter,
			...
			case DynamicPickContext dynamicPickContext ->
				new com.github.exopandora.shouldersurfing.api.client.world.phys.DynamicPickContext(
					this.camera,
					fluidContext,
					entity,
					entityFilter,
			...
			case ObstructionPickContext obstructionPickContext ->
				new com.github.exopandora.shouldersurfing.api.client.world.phys.ObstructionPickContext(
					this.camera,
					fluidContext,
					entity,
					entityFilter,
