...
public class ShoulderRenderer
{
	...
	{
		return Config.CLIENT.keepCameraOutOfHead() && this.cameraDistance < Minecraft.getMinecraft().thePlayer.width * 0.75F && ShoulderInstance.getInstance().doShoulderSurfing();
	}
