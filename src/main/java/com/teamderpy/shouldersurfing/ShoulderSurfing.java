...
public class ShoulderSurfing
{
	...
	public void syncConfig()
	{
		...
		ShoulderSettings.ENABLE_3PP_CROSSHAIR = CONFIG.get(Configuration.CATEGORY_GENERAL, "Third Person Crosshair", ShoulderSettings.ENABLE_3PP_CROSSHAIR, "Enable or disable the crosshair in third person").getBoolean(ShoulderSettings.ENABLE_3PP_CROSSHAIR);
		ShoulderSettings.ENABLE_1PP_CROSSHAIR = CONFIG.get(Configuration.CATEGORY_GENERAL, "First Person Crosshair", ShoulderSettings.ENABLE_1PP_CROSSHAIR, "Enable or disable the crosshair in first person").getBoolean(ShoulderSettings.ENABLE_1PP_CROSSHAIR);
		...
		ShoulderSettings.OVERRIDE_MOD_CROSSHAIRS = CONFIG.get(Configuration.CATEGORY_GENERAL, "Override Mod Crosshairs", ShoulderSettings.OVERRIDE_MOD_CROSSHAIRS, "Whether or not to override mod crosshairs").getBoolean(ShoulderSettings.OVERRIDE_MOD_CROSSHAIRS);
